    ...
    <>
      ...
      <nav className="relative z-10 flex justify-between items-center p-6 backdrop-blur-sm">
        ...
        <div className="hidden md:flex space-x-8">
          <a href="/automatisierungen" className="hover:text-blue-400 transition-colors duration-300">Automatisierungen</a>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden relative z-20 bg-black/95 backdrop-blur-sm border-t border-gray-800">
          <div className="px-6 py-4 space-y-4">
            <a href="/automatisierungen" className="block py-2 hover:text-blue-400 transition-colors duration-300">Automatisierungen</a>
