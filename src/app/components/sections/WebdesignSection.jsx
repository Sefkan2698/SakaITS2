          ...
          <div className="scroll-animate">
            <div className="space-y-8">
              ...
              <div className="flex space-x-4 pt-4">
                <a href="/webdesign" className="bg-green-600 hover:bg-green-700 px-6 py-3 rounded-lg transition-all duration-300 font-semibold inline-block text-center">
                  Mehr erfahren
                </a>
                <a href="/kontakt?kategorie=webdesign" className="border border-green-600 hover:bg-green-600 px-6 py-3 rounded-lg transition-all duration-300 font-semibold inline-block text-center">
                  Website anfragen
                </a>
              </div>
