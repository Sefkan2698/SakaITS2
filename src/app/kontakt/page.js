          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <a 
                ...
                className="flex items-center justify-center bg-green-600 hover:bg-green-700 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-green-500/25 transform hover:scale-105"
              >
              ...
              <a 
                ...
                className="flex items-center justify-center border-2 border-blue-400 hover:bg-blue-400 hover:text-black px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300"
              >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:kontakt@sakaits.com" className="text-gray-300 hover:text-blue-400 transition-colors">
                          kontakt@sakaits.com
                        </a>
                      </div>
                    </div>
                ...
                {/* Availability */}
                <div className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-500/20 rounded-2xl p-8">
