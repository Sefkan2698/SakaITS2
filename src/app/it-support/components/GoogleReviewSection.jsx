...
const GoogleReviewsSection = () => {
  ...
  const maxSlides = Math.ceil(reviews.length / itemsPerSlide);
  ...
  return (
    <section className="py-20 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center mb-4">
            <div className="flex items-center">
              {renderStars(5)}
              <span className="ml-3 text-xl md:text-2xl font-bold text-white">5.0</span>
        ...
        {/* Dot Indicators - Only on Desktop */}
        ...
        <div className="text-center mt-16">
          ...
          <a href="kontakt">
          <button   className="bg-gradient-to-r from-blue-600 to-cyan-600 px-6 md:px-8 py-3 md:py-4 rounded-lg text-base md:text-lg font-semibold text-white hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/25 transform hover:scale-105">
...
const ReviewCard = ({ review, renderStars }) => (
  <div className="bg-gray-800 border border-gray-700 rounded-2xl p-4 md:p-6 hover:border-gray-600 transition-all duration-300">
    
    {/* Review Header */}
    <div className="flex items-start justify-between mb-4">
      <div className="flex items-center">
        <div className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl ${
        ...
        <div className="ml-3 md:ml-4">
          <h4 className="font-semibold text-blue-400 text-base md:text-lg">{review.name}</h4>
          <p className="text-gray-400 text-xs md:text-sm">{review.reviewCount} • 0 Fotos</p>
        </div>
      </div>
    ...
    {/* Service Tag */}
    <div className="mb-4">
      <span className="inline-block bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-xs md:text-sm font-medium">
        {review.service}
      </span>
    </div>
    ...
    <div className="border-t border-gray-700 pt-4">
      <div className="flex items-center mb-2">
        ...
        <div className="ml-3">
          <p className="text-blue-400 font-semibold text-xs md:text-sm">Saka IT-Solutions</p>
          <p className="text-gray-500 text-xs">Inhaber</p>
        </div>
      </div>
      <p className="text-gray-400 text-xs md:text-sm">
        {review.name === 'LeeAnasaki' ? 'Vielen Dank für die netten Worte!' :
         review.name === 'Cornelia de Witt' ? 'Vielen Dank, immer wieder gerne!' :
         review.name === 'Klaus Vienken' ? 'Gerne wieder!' : ''}
      </p>
    </div>
